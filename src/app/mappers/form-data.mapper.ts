...
export const mapFormDataAirportToRequestDataAirport = (
  formDataAirports: string
): string[] | null => {
...
export const mapFormDataCountriesToRequestDataCountries = (
  formDataCountries: string
): string[] | null => {
...
export const mapFormDataMessageTypeToRequestDataReportType = (
  formDataMessageType: Record<keyof typeof ReportType, boolean>
): ReportType[] => {
